...
namespace WindowsFormsApplication21
{
    class fotos
    {
        static string cadenadebasededatos = @"Data Source=(localdb)\Projects;Initial Catalog=MapasyTex;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False";
        ...
        public static DataTable buscarfoto(int codigo)
        {
            DataTable Foto = new DataTable();
            SqlConnection conn = new SqlConnection(cadenadebasededatos);
            SqlCommand com = new SqlCommand("select * from fotos where id=@codigo;", conn);
